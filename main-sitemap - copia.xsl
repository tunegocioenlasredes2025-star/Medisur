			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Ubicaciones del mapa del sitio - Medisur</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - Medisur</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>Archivo KML</h1>
															...
															<p>
									Este archivo KML lo generó el plugin <a href="https://rankmath.com/" target="_blank">Rank Math WordPress SEO</a>. Se utiliza para darle información de la ubicación a Google.								</p>
							
							<p>
								Leé más sobre <a href="https://developers.google.com/kml/documentation/" target="_blank">archivos KML</a>.							</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<p>
								Leé más acerca de <a href="http://sitemaps.org/" target="_blank">mapas del sitio XML</a>.							</p>
